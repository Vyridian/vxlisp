...
public final class Http {
      ...
      for (Object valsub : vals) {
        if (valsub instanceof Core.Type_msgblock) {
          ...
          if (isvalidkey) {
            ...
            Core.Type_msg msg = Core.t_msg.vx_new_error("(new response) - Invalid Key Type: " + valsub.toString());
          ...
          case ":ok":
            if (valsub instanceof Core.Type_boolean) {
              ...
              Core.Type_msg msg = Core.t_msg.vx_new_error("(new response :ok " + valsub.toString() + ") - Invalid Value");
              msgblock = msgblock.vx_copy(msg);
            }
            break;
          case ":status":
            if (valsub instanceof Core.Type_int) {
              ...
              Core.Type_msg msg = Core.t_msg.vx_new_error("(new response :status " + valsub.toString() + ") - Invalid Value");
              msgblock = msgblock.vx_copy(msg);
            }
            break;
          default:
            Core.Type_msg msg = Core.t_msg.vx_new_error("(new response) - Invalid Key: " + key);
            msgblock = msgblock.vx_copy(msg);
          }
          key = "";
        }
  ...
  public static interface Func_csv_from_httpget extends Core.Func_any_from_any_async {
    public CompletableFuture<Csv.Type_csv> f_csv_from_httpget(final Core.Type_string url);
  }
  ...
  public static class Class_csv_from_httpget extends Core.Class_base implements Func_csv_from_httpget {
    ...
    public CompletableFuture<Core.Type_any> vx_repl(Core.Type_anylist arglist) {
      ...
      Core.Type_string url = Core.f_any_from_any(Core.t_string, arglist.vx_any(Core.t_int.vx_new_from_int(0)));
  ...
  public static CompletableFuture<Csv.Type_csv> f_csv_from_httpget(final Core.Type_string url) {
    ...
    output = Core.f_let_async(
      ...
      Core.t_any_from_func_async.fn_new(() -> {
        final CompletableFuture<Textblock.Type_textblock> future_textblock = Http.f_textblock_from_httpget(url, Core.t_string.vx_new_from_string("text/csv"));
  ...
  public static interface Func_json_from_httpget extends Core.Func_any_from_any_async {
    public CompletableFuture<Http.Type_response> f_json_from_httpget(final Core.Type_string url);
  }
  ...
  public static CompletableFuture<Http.Type_response> f_json_from_httpget(final Core.Type_string url) {
    ...
    output = Core.f_let_async(
      Http.t_response,
      Core.t_any_from_func_async.fn_new(() -> {
        final CompletableFuture<Http.Type_response> future_response = Http.f_response_from_httpget(url, Core.t_string.vx_new_from_string("application/json"));
  ...
  public static interface Func_response_from_httpget extends Core.Type_func, Core.Type_replfunc_async {
    public CompletableFuture<Http.Type_response> f_response_from_httpget(final Core.Type_string url, final Core.Type_string contenttype);
  }
  ...
  public static class Class_response_from_httpget extends Core.Class_base implements Func_response_from_httpget {
    ...
    public CompletableFuture<Core.Type_any> vx_repl(Core.Type_anylist arglist) {
      CompletableFuture<Core.Type_any> output = CompletableFuture.completedFuture(Core.e_any);
      Core.Type_string url = Core.f_any_from_any(Core.t_string, arglist.vx_any(Core.t_int.vx_new_from_int(0)));
      Core.Type_string contenttype = Core.f_any_from_any(Core.t_string, arglist.vx_any(Core.t_int.vx_new_from_int(1)));
  ...
  public static interface Func_text_from_httpget extends Core.Func_any_from_any_async {
    public CompletableFuture<Core.Type_string> f_text_from_httpget(final Core.Type_string url);
  }
  ...
  public static CompletableFuture<Core.Type_string> f_text_from_httpget(final Core.Type_string url) {
    ...
    output = Core.f_let_async(
      Core.t_string,
      Core.t_any_from_func_async.fn_new(() -> {
        final CompletableFuture<Http.Type_response> future_response = Http.f_response_from_httpget(url, Core.t_string.vx_new_from_string("text/plain"));
        return Core.async_from_async_fn(future_response, (response) -> {
  ...
  public static interface Func_text_from_response extends Core.Func_any_from_any {
    public Core.Type_string f_text_from_response(final Http.Type_response response);
  }
  ...
  public static class Class_text_from_response extends Core.Class_base implements Func_text_from_response {
    ...
    public Core.Type_any vx_repl(Core.Type_anylist arglist) {
      Core.Type_any output = Core.e_any;
      Http.Type_response response = Core.f_any_from_any(Http.t_response, arglist.vx_any(Core.t_int.vx_new_from_int(0)));
  ...
  public static interface Func_textblock_from_httpget extends Core.Type_func, Core.Type_replfunc_async {
    public CompletableFuture<Textblock.Type_textblock> f_textblock_from_httpget(final Core.Type_string url, final Core.Type_string contenttype);
  }
  ...
  public static interface Func_textblock_from_response extends Core.Func_any_from_any {
    public Textblock.Type_textblock f_textblock_from_response(final Http.Type_response response);
  }
  ...
  public static interface Func_xml_from_httpget extends Core.Func_any_from_any_async {
    public CompletableFuture<Xml.Type_xml> f_xml_from_httpget(final Core.Type_string url);
  }
  ...
  public static CompletableFuture<Xml.Type_xml> f_xml_from_httpget(final Core.Type_string url) {
    ...
    output = Core.f_let_async(
      Xml.t_xml,
      Core.t_any_from_func_async.fn_new(() -> {
        final CompletableFuture<Textblock.Type_textblock> future_textblock = Http.f_textblock_from_httpget(url, Core.t_string.vx_new_from_string("text/xml"));
        return Core.async_from_async_fn(future_textblock, (textblock) -> {
