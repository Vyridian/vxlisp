...
func LangFuncClassFull(lang *vxlang, fnc *vxfunc) string {
...
func LangFuncE(lang *vxlang, fnc *vxfunc) string {
...
func LangFuncF(lang *vxlang, fnc *vxfunc) string {
			...
			if fnc.async {
				defaultvalue =
					LangVarFutureGeneric(lang, "output", returntype, indent,
						LangPkgNameDot(lang, "vx/core")+"vx_async_new_from_value("+LangTypeE(lang, fnc.vxtype)+")")
...
func LangFuncFunc(lang *vxlang, fnc *vxfunc) string {
	name := "Func_" + LangFuncName(fnc)
	return name
}

func LangFuncFuncFull(lang *vxlang, fnc *vxfunc) string {
