...
public final class Type {
  ...
  public static class Class_allowtypenames_from_type extends Core.Class_base implements Func_allowtypenames_from_type {
    ...
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_allowtypenames_from_type;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_allowtypenames_from_type;
      return output;
    }
    ...
    @Override
    public Core.Type_stringlist vx_allowtypenames_from_type(final Core.Type_any type) {
      Core.Type_stringlist output = Type.f_allowtypenames_from_type(type);
      return output;
    }

  }

  public static final Type.Func_allowtypenames_from_type e_allowtypenames_from_type = new Type.Class_allowtypenames_from_type();
  public static final Type.Func_allowtypenames_from_type t_allowtypenames_from_type = new Type.Class_allowtypenames_from_type();
  ...
  public static class Class_allowtypes_from_type extends Core.Class_base implements Func_allowtypes_from_type {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_allowtypes_from_type;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_allowtypes_from_type;
      return output;
    }
    ...
    @Override
    public Core.Type_typelist vx_allowtypes_from_type(final Core.Type_any type) {
      Core.Type_typelist output = Type.f_allowtypes_from_type(type);
      return output;
    }

  }

  public static final Type.Func_allowtypes_from_type e_allowtypes_from_type = new Type.Class_allowtypes_from_type();
  public static final Type.Func_allowtypes_from_type t_allowtypes_from_type = new Type.Class_allowtypes_from_type();
  ...
  public static class Class_any_from_int extends Core.Class_base implements Func_any_from_int {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_any_from_int;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_any_from_int;
      return output;
    }
  ...
  public static class Class_boolean_from_string_ends extends Core.Class_base implements Func_boolean_from_string_ends {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_boolean_from_string_ends;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_boolean_from_string_ends;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_boolean_from_string_ends(final Core.Type_string text, final Core.Type_string ends) {
      Core.Type_boolean output = Type.f_boolean_from_string_ends(text, ends);
      return output;
    }

  }

  public static final Type.Func_boolean_from_string_ends e_boolean_from_string_ends = new Type.Class_boolean_from_string_ends();
  public static final Type.Func_boolean_from_string_ends t_boolean_from_string_ends = new Type.Class_boolean_from_string_ends();
  ...
  public static class Class_boolean_from_string_starts extends Core.Class_base implements Func_boolean_from_string_starts {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_boolean_from_string_starts;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_boolean_from_string_starts;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_boolean_from_string_starts(final Core.Type_string text, final Core.Type_string starts) {
      Core.Type_boolean output = Type.f_boolean_from_string_starts(text, starts);
      return output;
    }

  }

  public static final Type.Func_boolean_from_string_starts e_boolean_from_string_starts = new Type.Class_boolean_from_string_starts();
  public static final Type.Func_boolean_from_string_starts t_boolean_from_string_starts = new Type.Class_boolean_from_string_starts();
  ...
  public static class Class_int_from_string_find extends Core.Class_base implements Func_int_from_string_find {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_int_from_string_find;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_int_from_string_find;
      return output;
    }
    ...
    @Override
    public Core.Type_int vx_int_from_string_find(final Core.Type_string text, final Core.Type_string find) {
      Core.Type_int output = Type.f_int_from_string_find(text, find);
      return output;
    }

  }

  public static final Type.Func_int_from_string_find e_int_from_string_find = new Type.Class_int_from_string_find();
  public static final Type.Func_int_from_string_find t_int_from_string_find = new Type.Class_int_from_string_find();
  ...
  public static class Class_int_from_string_findkeyword extends Core.Class_base implements Func_int_from_string_findkeyword {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_int_from_string_findkeyword;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_int_from_string_findkeyword;
      return output;
    }
    ...
    @Override
    public Core.Type_int vx_int_from_string_findkeyword(final Core.Type_string text, final Core.Type_string find) {
      Core.Type_int output = Type.f_int_from_string_findkeyword(text, find);
      return output;
    }

  }

  public static final Type.Func_int_from_string_findkeyword e_int_from_string_findkeyword = new Type.Class_int_from_string_findkeyword();
  public static final Type.Func_int_from_string_findkeyword t_int_from_string_findkeyword = new Type.Class_int_from_string_findkeyword();
  ...
  public static class Class_int_from_string_findlast extends Core.Class_base implements Func_int_from_string_findlast {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_int_from_string_findlast;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_int_from_string_findlast;
      return output;
    }
    ...
    @Override
    public Core.Type_int vx_int_from_string_findlast(final Core.Type_string text, final Core.Type_string findlast) {
      Core.Type_int output = Type.f_int_from_string_findlast(text, findlast);
      return output;
    }

  }

  public static final Type.Func_int_from_string_findlast e_int_from_string_findlast = new Type.Class_int_from_string_findlast();
  public static final Type.Func_int_from_string_findlast t_int_from_string_findlast = new Type.Class_int_from_string_findlast();
  ...
  public static class Class_is_boolean extends Core.Class_base implements Func_is_boolean {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_boolean;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_boolean;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_is_boolean(final Core.Type_any value) {
      Core.Type_boolean output = Type.f_is_boolean(value);
      return output;
    }

  }

  public static final Type.Func_is_boolean e_is_boolean = new Type.Class_is_boolean();
  public static final Type.Func_is_boolean t_is_boolean = new Type.Class_is_boolean();
  ...
  public static class Class_is_decimal extends Core.Class_base implements Func_is_decimal {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_decimal;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_decimal;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_is_decimal(final Core.Type_any value) {
      Core.Type_boolean output = Type.f_is_decimal(value);
      return output;
    }

  }

  public static final Type.Func_is_decimal e_is_decimal = new Type.Class_is_decimal();
  public static final Type.Func_is_decimal t_is_decimal = new Type.Class_is_decimal();
  ...
  public static class Class_is_none extends Core.Class_base implements Func_is_none {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_none;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_none;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_is_none(final Core.Type_any value) {
      Core.Type_boolean output = Type.f_is_none(value);
      return output;
    }

  }

  public static final Type.Func_is_none e_is_none = new Type.Class_is_none();
  public static final Type.Func_is_none t_is_none = new Type.Class_is_none();
  ...
  public static class Class_is_string extends Core.Class_base implements Func_is_string {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_string;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_string;
      return output;
    }
    ...
    @Override
    public Core.Type_boolean vx_is_string(final Core.Type_any value) {
      Core.Type_boolean output = Type.f_is_string(value);
      return output;
    }

  }

  public static final Type.Func_is_string e_is_string = new Type.Class_is_string();
  public static final Type.Func_is_string t_is_string = new Type.Class_is_string();
  ...
  public static class Class_is_type extends Core.Class_base implements Func_is_type {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_type;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_type;
      return output;
    }
  ...
  public static class Class_is_type_from_any_typelist extends Core.Class_base implements Func_is_type_from_any_typelist {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_is_type_from_any_typelist;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_is_type_from_any_typelist;
      return output;
    }
  ...
  public static class Class_string_lowercase extends Core.Class_base implements Func_string_lowercase {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_lowercase;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_lowercase;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_lowercase(final Core.Type_string text) {
      Core.Type_string output = Type.f_string_lowercase(text);
      return output;
    }

  }

  public static final Type.Func_string_lowercase e_string_lowercase = new Type.Class_string_lowercase();
  public static final Type.Func_string_lowercase t_string_lowercase = new Type.Class_string_lowercase();
  ...
  public static class Class_string_outdent extends Core.Class_base implements Func_string_outdent {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_outdent;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_outdent;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_outdent(final Core.Type_string text) {
      Core.Type_string output = Type.f_string_outdent(text);
      return output;
    }

  }

  public static final Type.Func_string_outdent e_string_outdent = new Type.Class_string_outdent();
  public static final Type.Func_string_outdent t_string_outdent = new Type.Class_string_outdent();
              ...
              Core.t_any_from_func.vx_fn_new(() -> {
                Core.Type_any output_4 = Core.f_let(
                  ...
                  Core.t_any_from_func.vx_fn_new(() -> {
                    ...
                    Core.Type_string rest = Type.f_string_from_string_start(
                      text,
                      pos
                    );
                    Core.Type_int linepos = Type.f_int_from_string_find(
                      indent,
                      Core.vx_new_string("\n")
                    );
                    ...
                    Core.Type_any output_5 = Core.f_string_from_string_find_replace(
                      rest,
                      indent,
                      outdent
                    );
  ...
  public static class Class_string_trim extends Core.Class_base implements Func_string_trim {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_trim;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_trim;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_trim(final Core.Type_string text) {
      Core.Type_string output = Type.f_string_trim(text);
      return output;
    }

  }

  public static final Type.Func_string_trim e_string_trim = new Type.Class_string_trim();
  public static final Type.Func_string_trim t_string_trim = new Type.Class_string_trim();
  ...
  public static class Class_string_uppercase extends Core.Class_base implements Func_string_uppercase {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_uppercase;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_uppercase;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_uppercase(final Core.Type_string text) {
      Core.Type_string output = Type.f_string_uppercase(text);
      return output;
    }

  }

  public static final Type.Func_string_uppercase e_string_uppercase = new Type.Class_string_uppercase();
  public static final Type.Func_string_uppercase t_string_uppercase = new Type.Class_string_uppercase();
  ...
  public static class Class_string_from_int extends Core.Class_base implements Func_string_from_int {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_from_int;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_from_int;
      return output;
    }
  ...
  public static class Class_string_from_string_end extends Core.Class_base implements Func_string_from_string_end {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_from_string_end;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_from_string_end;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_from_string_end(final Core.Type_string text, final Core.Type_int endpos) {
      Core.Type_string output = Type.f_string_from_string_end(text, endpos);
      return output;
    }

  }

  public static final Type.Func_string_from_string_end e_string_from_string_end = new Type.Class_string_from_string_end();
  public static final Type.Func_string_from_string_end t_string_from_string_end = new Type.Class_string_from_string_end();
  ...
  public static class Class_string_from_string_start extends Core.Class_base implements Func_string_from_string_start {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_from_string_start;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_from_string_start;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_from_string_start(final Core.Type_string text, final Core.Type_int startpos) {
      Core.Type_string output = Type.f_string_from_string_start(text, startpos);
      return output;
    }

  }

  public static final Type.Func_string_from_string_start e_string_from_string_start = new Type.Class_string_from_string_start();
  public static final Type.Func_string_from_string_start t_string_from_string_start = new Type.Class_string_from_string_start();
  ...
  public static class Class_string_from_string_start_end extends Core.Class_base implements Func_string_from_string_start_end {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_from_string_start_end;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_from_string_start_end;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_from_string_start_end(final Core.Type_string text, final Core.Type_int start, final Core.Type_int end) {
      Core.Type_string output = Type.f_string_from_string_start_end(text, start, end);
      return output;
    }

  }

  public static final Type.Func_string_from_string_start_end e_string_from_string_start_end = new Type.Class_string_from_string_start_end();
  public static final Type.Func_string_from_string_start_end t_string_from_string_start_end = new Type.Class_string_from_string_start_end();
  ...
  public static class Class_string_from_stringlist_join extends Core.Class_base implements Func_string_from_stringlist_join {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_string_from_stringlist_join;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_string_from_stringlist_join;
      return output;
    }
    ...
    @Override
    public Core.Type_string vx_string_from_stringlist_join(final Core.Type_stringlist vals, final Core.Type_string delim) {
      Core.Type_string output = Type.f_string_from_stringlist_join(vals, delim);
      return output;
    }

  }

  public static final Type.Func_string_from_stringlist_join e_string_from_stringlist_join = new Type.Class_string_from_stringlist_join();
  public static final Type.Func_string_from_stringlist_join t_string_from_stringlist_join = new Type.Class_string_from_stringlist_join();
  ...
  public static class Class_stringlist_from_string_split extends Core.Class_base implements Func_stringlist_from_string_split {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_stringlist_from_string_split;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_stringlist_from_string_split;
      return output;
    }
    ...
    @Override
    public Core.Type_stringlist vx_stringlist_from_string_split(final Core.Type_string text, final Core.Type_string delim) {
      Core.Type_stringlist output = Type.f_stringlist_from_string_split(text, delim);
      return output;
    }

  }

  public static final Type.Func_stringlist_from_string_split e_stringlist_from_string_split = new Type.Class_stringlist_from_string_split();
  public static final Type.Func_stringlist_from_string_split t_stringlist_from_string_split = new Type.Class_stringlist_from_string_split();
  ...
  public static class Class_traitnames_from_any extends Core.Class_base implements Func_traitnames_from_any {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_traitnames_from_any;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_traitnames_from_any;
      return output;
    }
  ...
  public static class Class_traits_from_any extends Core.Class_base implements Func_traits_from_any {
    ...
    @Override
    public Core.Type_any vx_empty() {
      Core.Type_any output = Type.e_traits_from_any;
      return output;
    }

    @Override
    public Core.Type_any vx_type() {
      Core.Type_any output = Type.t_traits_from_any;
      return output;
    }
