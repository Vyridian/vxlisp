...
namespace vx_data_csv {
  ...
  public:
    template<class... Args> vx_data_csv::Type_csv* vx_new(Args*... args);
    template<class... Args> vx_data_csv::Type_csv* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_csv::Type_csvrows* vx_new(Args*... args);
    template<class... Args> vx_data_csv::Type_csvrows* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_csv::Func_csv_from_textblock* vx_new(Args*... args);
    template<class... Args> vx_data_csv::Func_csv_from_textblock* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_csv::Func_csvrows_from_textblock* vx_new(Args*... args);
    template<class... Args> vx_data_csv::Func_csvrows_from_textblock* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
