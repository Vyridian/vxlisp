...
namespace vx_data_xml {
  ...
  public:
    template<class... Args> vx_data_xml::Type_xml* vx_new(Args*... args);
    template<class... Args> vx_data_xml::Type_xml* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_xml::Type_xmlnode* vx_new(Args*... args);
    template<class... Args> vx_data_xml::Type_xmlnode* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_xml::Type_xmlnodelist* vx_new(Args*... args);
    template<class... Args> vx_data_xml::Type_xmlnodelist* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_xml::Type_xmlpropmap* vx_new(Args*... args);
    template<class... Args> vx_data_xml::Type_xmlpropmap* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_data_xml::Func_xml_from_textblock* vx_new(Args*... args);
    template<class... Args> vx_data_xml::Func_xml_from_textblock* vx_copy(Args*... args);
