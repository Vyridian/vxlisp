...
namespace vx_state {
  ...
  public:
    template<class... Args> vx_state::Type_value_map* vx_new(Args*... args);
    template<class... Args> vx_state::Type_value_map* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_state::Func_change* vx_new(Args*... args);
    template<class... Args> vx_state::Func_change* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_state::Func_register* vx_new(Args*... args);
    template<class... Args> vx_state::Func_register* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
