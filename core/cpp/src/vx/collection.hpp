...
namespace vx_collection {
  ...
  public:
    template<class... Args> vx_collection::Func_is_list* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_is_list* vx_copy(Args*... args);
  ...
  public:
    template<class... Args> vx_collection::Func_is_map* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_is_map* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<class... Args> vx_collection::Func_list_from_list_end* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_list_from_list_end* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<class... Args> vx_collection::Func_list_from_list_filtertypes* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_list_from_list_filtertypes* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<class... Args> vx_collection::Func_list_from_list_fn_filter* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_list_from_list_fn_filter* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<class... Args> vx_collection::Func_list_from_list_start* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_list_from_list_start* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<class... Args> vx_collection::Func_list_from_list_start_end* vx_new(Args*... args);
    template<class... Args> vx_collection::Func_list_from_list_start_end* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
