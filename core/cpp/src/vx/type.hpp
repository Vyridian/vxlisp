...
namespace vx_type {
  ...
  public:
    template<typename... Args> vx_type::Func_allowtypenames_from_type* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_allowtypenames_from_type* vx_copy(Args*... args);
  ...
  public:
    template<typename... Args> vx_type::Func_allowtypes_from_type* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_allowtypes_from_type* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_boolean* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_boolean* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_decimal* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_decimal* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_float* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_float* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_none* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_none* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_string* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_string* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_type* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_type* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_is_type_from_any_typelist* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_is_type_from_any_typelist* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_length_from_string* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_length_from_string* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_string_from_int* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_string_from_int* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_string_from_string_end* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_string_from_string_end* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_string_from_string_start* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_string_from_string_start* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_string_from_string_start_end* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_string_from_string_start_end* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_string_from_stringlist_join* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_string_from_stringlist_join* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_traitnames_from_any* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_traitnames_from_any* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_traits_from_any* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_traits_from_any* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
  ...
  public:
    template<typename... Args> vx_type::Func_traits_from_typedef* vx_new(Args*... args);
    template<typename... Args> vx_type::Func_traits_from_typedef* vx_copy(Args*... args);
    virtual vx_core::Type_funcdef* vx_funcdef();
    virtual vx_core::Type_typedef* vx_typedef();
