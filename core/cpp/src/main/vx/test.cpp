...
//namespace vx_test {
  ...
  //class Type_testcase {
    // passfail()
    vx_core::Type_boolean vx_test::Class_testcase::passfail() {
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testcase::testpkg() {
    ...
    // casename()
    vx_core::Type_string vx_test::Class_testcase::casename() {
    ...
    // describelist()
    vx_test::Type_testdescribelist vx_test::Class_testcase::describelist() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testcase::vx_map() {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcase::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testcase->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcase::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testcase;}
    template <class T> std::shared_ptr<T> vx_test::Class_testcase::vx_type(std::shared_ptr<T> val) {return vx_test::t_testcase;}

    vx_core::Type_typedef vx_test::Class_testcase::vx_typedef() {
    ...
    vx_test::Type_testcase vx_test::e_testcase = std::make_shared<vx_test::Class_testcase>();
    vx_test::Type_testcase vx_test::t_testcase = std::make_shared<vx_test::Class_testcase>();
  //}
  ...
  //class Type_testcaselist {
    vx_core::vx_Type_listany vx_test::Class_testcaselist::vx_list() {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcaselist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testcaselist;}
    template <class T> std::shared_ptr<T> vx_test::Class_testcaselist::vx_type(std::shared_ptr<T> val) {return vx_test::t_testcaselist;}

    vx_core::Type_typedef vx_test::Class_testcaselist::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testcaselist", // name
        ":list", // extends
        vx_core::e_typelist, // traits
        vx_core::t_typelist->vx_new(vx_core::t_typelist, {vx_test::t_testcase}), // allowtypes
        vx_core::e_typelist, // disallowtypes
        vx_core::e_funclist, // allowfuncs
        vx_core::e_funclist, // disallowfuncs
        vx_core::e_anylist, // allowvalues
    ...
    vx_test::Type_testcaselist vx_test::e_testcaselist = std::make_shared<vx_test::Class_testcaselist>();
    vx_test::Type_testcaselist vx_test::t_testcaselist = std::make_shared<vx_test::Class_testcaselist>();
  //}
  ...
  //class Type_testcoveragedetail {
    // constmap()
    vx_core::Type_intmap vx_test::Class_testcoveragedetail::constmap() {
    ...
    // funcmap()
    vx_core::Type_intmap vx_test::Class_testcoveragedetail::funcmap() {
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testcoveragedetail::testpkg() {
      vx_core::Type_string output = this->vx_p_testpkg;
      if (output == NULL) {
        output = vx_core::t_string;
      }
    ...
    // typemap()
    vx_core::Type_intmap vx_test::Class_testcoveragedetail::typemap() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testcoveragedetail::vx_map() {
      vx_core::vx_Type_mapany output;
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragedetail::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testcoveragedetail->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragedetail::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testcoveragedetail;}
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragedetail::vx_type(std::shared_ptr<T> val) {return vx_test::t_testcoveragedetail;}

    vx_core::Type_typedef vx_test::Class_testcoveragedetail::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
    ...
    vx_test::Type_testcoveragedetail vx_test::e_testcoveragedetail = std::make_shared<vx_test::Class_testcoveragedetail>();
    vx_test::Type_testcoveragedetail vx_test::t_testcoveragedetail = std::make_shared<vx_test::Class_testcoveragedetail>();
  //}
  ...
  //class Type_testcoveragenums {
    // pct()
    vx_core::Type_int vx_test::Class_testcoveragenums::pct() {
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testcoveragenums::testpkg() {
      vx_core::Type_string output = this->vx_p_testpkg;
      if (output == NULL) {
        output = vx_core::t_string;
      }
    ...
    // tests()
    vx_core::Type_int vx_test::Class_testcoveragenums::tests() {
    ...
    // total()
    vx_core::Type_int vx_test::Class_testcoveragenums::total() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testcoveragenums::vx_map() {
      vx_core::vx_Type_mapany output;
      output[":pct"] = this->pct();
      output[":testpkg"] = this->testpkg();
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragenums::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testcoveragenums->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragenums::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testcoveragenums;}
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragenums::vx_type(std::shared_ptr<T> val) {return vx_test::t_testcoveragenums;}

    vx_core::Type_typedef vx_test::Class_testcoveragenums::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
    ...
    vx_test::Type_testcoveragenums vx_test::e_testcoveragenums = std::make_shared<vx_test::Class_testcoveragenums>();
    vx_test::Type_testcoveragenums vx_test::t_testcoveragenums = std::make_shared<vx_test::Class_testcoveragenums>();
  //}
  ...
  //class Type_testcoveragesummary {
    // bigospacenums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::bigospacenums() {
    ...
    // bigotimenums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::bigotimenums() {
    ...
    // constnums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::constnums() {
    ...
    // docnums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::docnums() {
    ...
    // funcnums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::funcnums() {
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testcoveragesummary::testpkg() {
      vx_core::Type_string output = this->vx_p_testpkg;
      if (output == NULL) {
        output = vx_core::t_string;
      }
    ...
    // totalnums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::totalnums() {
    ...
    // typenums()
    vx_test::Type_testcoveragenums vx_test::Class_testcoveragesummary::typenums() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testcoveragesummary::vx_map() {
      vx_core::vx_Type_mapany output;
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragesummary::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testcoveragesummary->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragesummary::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testcoveragesummary;}
    template <class T> std::shared_ptr<T> vx_test::Class_testcoveragesummary::vx_type(std::shared_ptr<T> val) {return vx_test::t_testcoveragesummary;}

    vx_core::Type_typedef vx_test::Class_testcoveragesummary::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
    ...
    vx_test::Type_testcoveragesummary vx_test::e_testcoveragesummary = std::make_shared<vx_test::Class_testcoveragesummary>();
    vx_test::Type_testcoveragesummary vx_test::t_testcoveragesummary = std::make_shared<vx_test::Class_testcoveragesummary>();
  //}
  ...
  //class Type_testdescribe {
    // describename()
    vx_core::Type_string vx_test::Class_testdescribe::describename() {
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testdescribe::testpkg() {
      vx_core::Type_string output = this->vx_p_testpkg;
      if (output == NULL) {
        output = vx_core::t_string;
      }
    ...
    // testresult()
    vx_test::Type_testresult vx_test::Class_testdescribe::testresult() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testdescribe::vx_map() {
      vx_core::vx_Type_mapany output;
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testdescribe::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testdescribe->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testdescribe::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testdescribe;}
    template <class T> std::shared_ptr<T> vx_test::Class_testdescribe::vx_type(std::shared_ptr<T> val) {return vx_test::t_testdescribe;}

    vx_core::Type_typedef vx_test::Class_testdescribe::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testdescribe", // name
        ":struct", // extends
    ...
    vx_test::Type_testdescribe vx_test::e_testdescribe = std::make_shared<vx_test::Class_testdescribe>();
    vx_test::Type_testdescribe vx_test::t_testdescribe = std::make_shared<vx_test::Class_testdescribe>();
  //}
  ...
  //class Type_testdescribelist {
    vx_core::vx_Type_listany vx_test::Class_testdescribelist::vx_list() {
      return vx_core::list_from_list(vx_core::t_any, this->vx_p_list);
    }
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testdescribelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testdescribelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_testdescribelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_testdescribelist;}

    vx_core::Type_typedef vx_test::Class_testdescribelist::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testdescribelist", // name
        ":list", // extends
        vx_core::e_typelist, // traits
        vx_core::t_typelist->vx_new(vx_core::t_typelist, {vx_test::t_testdescribe}), // allowtypes
        vx_core::e_typelist, // disallowtypes
        vx_core::e_funclist, // allowfuncs
        vx_core::e_funclist, // disallowfuncs
        vx_core::e_anylist, // allowvalues
    ...
    vx_test::Type_testdescribelist vx_test::e_testdescribelist = std::make_shared<vx_test::Class_testdescribelist>();
    vx_test::Type_testdescribelist vx_test::t_testdescribelist = std::make_shared<vx_test::Class_testdescribelist>();
  //}
  ...
  //class Type_testpackage {
    // caselist()
    vx_test::Type_testcaselist vx_test::Class_testpackage::caselist() {
    ...
    // coveragedetail()
    vx_test::Type_testcoveragedetail vx_test::Class_testpackage::coveragedetail() {
    ...
    // coveragesummary()
    vx_test::Type_testcoveragesummary vx_test::Class_testpackage::coveragesummary() {
    ...
    // passfail()
    vx_core::Type_boolean vx_test::Class_testpackage::passfail() {
      vx_core::Type_boolean output = this->vx_p_passfail;
      if (output == NULL) {
        output = vx_core::t_boolean;
      }
    ...
    // testpkg()
    vx_core::Type_string vx_test::Class_testpackage::testpkg() {
      vx_core::Type_string output = this->vx_p_testpkg;
      if (output == NULL) {
        output = vx_core::t_string;
      }
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testpackage::vx_map() {
      vx_core::vx_Type_mapany output;
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testpackage::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testpackage->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testpackage::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testpackage;}
    template <class T> std::shared_ptr<T> vx_test::Class_testpackage::vx_type(std::shared_ptr<T> val) {return vx_test::t_testpackage;}

    vx_core::Type_typedef vx_test::Class_testpackage::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testpackage", // name
        ":struct", // extends
    ...
    vx_test::Type_testpackage vx_test::e_testpackage = std::make_shared<vx_test::Class_testpackage>();
    vx_test::Type_testpackage vx_test::t_testpackage = std::make_shared<vx_test::Class_testpackage>();
  //}
  ...
  //class Type_testpackagelist {
    vx_core::vx_Type_listany vx_test::Class_testpackagelist::vx_list() {
      return vx_core::list_from_list(vx_core::t_any, this->vx_p_list);
    }
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testpackagelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testpackagelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_testpackagelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_testpackagelist;}

    vx_core::Type_typedef vx_test::Class_testpackagelist::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testpackagelist", // name
        ":list", // extends
        vx_core::e_typelist, // traits
        vx_core::t_typelist->vx_new(vx_core::t_typelist, {vx_test::t_testpackage}), // allowtypes
        vx_core::e_typelist, // disallowtypes
        vx_core::e_funclist, // allowfuncs
        vx_core::e_funclist, // disallowfuncs
        vx_core::e_anylist, // allowvalues
    ...
    vx_test::Type_testpackagelist vx_test::e_testpackagelist = std::make_shared<vx_test::Class_testpackagelist>();
    vx_test::Type_testpackagelist vx_test::t_testpackagelist = std::make_shared<vx_test::Class_testpackagelist>();
  //}
  ...
  //class Type_testresult {
    // code()
    vx_core::Type_string vx_test::Class_testresult::code() {
    ...
    // passfail()
    vx_core::Type_boolean vx_test::Class_testresult::passfail() {
      vx_core::Type_boolean output = this->vx_p_passfail;
      if (output == NULL) {
        output = vx_core::t_boolean;
      }
    ...
    // expected()
    vx_core::Type_any vx_test::Class_testresult::expected() {
    ...
    // actual()
    vx_core::Type_any vx_test::Class_testresult::actual() {
    ...
    // fn_actual()
    vx_core::Func_any_from_func_async vx_test::Class_testresult::fn_actual() {
    ...
    // vx_map()
    vx_core::vx_Type_mapany vx_test::Class_testresult::vx_map() {
      vx_core::vx_Type_mapany output;
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testresult::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {return vx_test::e_testresult->vx_copy(generic_any_1, vals);}
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testresult::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testresult;}
    template <class T> std::shared_ptr<T> vx_test::Class_testresult::vx_type(std::shared_ptr<T> val) {return vx_test::t_testresult;}

    vx_core::Type_typedef vx_test::Class_testresult::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testresult", // name
        ":struct", // extends
    ...
    vx_test::Type_testresult vx_test::e_testresult = std::make_shared<vx_test::Class_testresult>();
    vx_test::Type_testresult vx_test::t_testresult = std::make_shared<vx_test::Class_testresult>();
  //}
  ...
  //class Type_testresultlist {
    vx_core::vx_Type_listany vx_test::Class_testresultlist::vx_list() {
      return vx_core::list_from_list(vx_core::t_any, this->vx_p_list);
    }
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_testresultlist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_testresultlist;}
    template <class T> std::shared_ptr<T> vx_test::Class_testresultlist::vx_type(std::shared_ptr<T> val) {return vx_test::t_testresultlist;}

    vx_core::Type_typedef vx_test::Class_testresultlist::vx_typedef() {
      return vx_core::Class_typedef::vx_typedef_new(
        "vx/test", // pkgname
        "testresultlist", // name
        ":list", // extends
        vx_core::e_typelist, // traits
        vx_core::t_typelist->vx_new(vx_core::t_typelist, {vx_test::t_testresult}), // allowtypes
        vx_core::e_typelist, // disallowtypes
        vx_core::e_funclist, // allowfuncs
        vx_core::e_funclist, // disallowfuncs
        vx_core::e_anylist, // allowvalues
    ...
    vx_test::Type_testresultlist vx_test::e_testresultlist = std::make_shared<vx_test::Class_testresultlist>();
    vx_test::Type_testresultlist vx_test::t_testresultlist = std::make_shared<vx_test::Class_testresultlist>();
  //}
  ...
  //class Class_stylesheet_test {
    ...
    // vx_constdef()
    vx_core::Type_constdef vx_test::Class_stylesheet_test::vx_constdef() {
    ...
    vx_test::Const_stylesheet_test vx_test::Class_stylesheet_test::vx_const_new() {
      vx_test::Const_stylesheet_test output = std::shared_ptr<vx_test::Class_stylesheet_test>();
  ...
  vx_test::Const_stylesheet_test vx_test::c_stylesheet_test = vx_test::Class_stylesheet_test::vx_const_new();
  ...
  //class Func_div_from_testcaselist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testcaselist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testcaselist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testcaselist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testcaselist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_div_from_testcaselist::vx_typedef() {return vx_test::t_div_from_testcaselist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_div_from_testcaselist::vx_funcdef() {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testcaselist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_div_from_testcaselist;}
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testcaselist::vx_type(std::shared_ptr<T> val) {return vx_test::t_div_from_testcaselist;}

    vx_core::Func_any_from_any vx_test::Class_div_from_testcaselist::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_div_from_testcaselist::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
  ...
  vx_test::Func_div_from_testcaselist vx_test::e_div_from_testcaselist = std::make_shared<vx_test::Class_div_from_testcaselist>();
  vx_test::Func_div_from_testcaselist vx_test::t_div_from_testcaselist = std::make_shared<vx_test::Class_div_from_testcaselist>();
  ...
  //class Func_div_from_testpackage {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackage::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testpackage output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackage::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testpackage output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_div_from_testpackage::vx_typedef() {return vx_test::t_div_from_testpackage->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_div_from_testpackage::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackage::vx_empty(std::shared_ptr<T> val) {return vx_test::e_div_from_testpackage;}
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackage::vx_type(std::shared_ptr<T> val) {return vx_test::t_div_from_testpackage;}

    vx_core::Func_any_from_any vx_test::Class_div_from_testpackage::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_div_from_testpackage::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_div_from_testpackage vx_test::e_div_from_testpackage = std::make_shared<vx_test::Class_div_from_testpackage>();
  vx_test::Func_div_from_testpackage vx_test::t_div_from_testpackage = std::make_shared<vx_test::Class_div_from_testpackage>();
  ...
  //class Func_div_from_testpackagelist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackagelist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testpackagelist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackagelist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_div_from_testpackagelist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_div_from_testpackagelist::vx_typedef() {return vx_test::t_div_from_testpackagelist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_div_from_testpackagelist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackagelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_div_from_testpackagelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_div_from_testpackagelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_div_from_testpackagelist;}

    vx_core::Func_any_from_any vx_test::Class_div_from_testpackagelist::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_div_from_testpackagelist::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_div_from_testpackagelist vx_test::e_div_from_testpackagelist = std::make_shared<vx_test::Class_div_from_testpackagelist>();
  vx_test::Func_div_from_testpackagelist vx_test::t_div_from_testpackagelist = std::make_shared<vx_test::Class_div_from_testpackagelist>();
  ...
  //class Func_divchildlist_from_testpackagelist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_divchildlist_from_testpackagelist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_divchildlist_from_testpackagelist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_divchildlist_from_testpackagelist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_divchildlist_from_testpackagelist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_divchildlist_from_testpackagelist::vx_typedef() {return vx_test::t_divchildlist_from_testpackagelist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_divchildlist_from_testpackagelist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_divchildlist_from_testpackagelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_divchildlist_from_testpackagelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_divchildlist_from_testpackagelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_divchildlist_from_testpackagelist;}

    vx_core::Func_any_from_any vx_test::Class_divchildlist_from_testpackagelist::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_divchildlist_from_testpackagelist::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
      vx_test::Type_testpackagelist inputval = (vx_test::Type_testpackagelist)value;
  ...
  vx_test::Func_divchildlist_from_testpackagelist vx_test::e_divchildlist_from_testpackagelist = std::make_shared<vx_test::Class_divchildlist_from_testpackagelist>();
  vx_test::Func_divchildlist_from_testpackagelist vx_test::t_divchildlist_from_testpackagelist = std::make_shared<vx_test::Class_divchildlist_from_testpackagelist>();
  ...
  //class Func_file_test {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_test::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_test output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_file_test::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_test output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_file_test::vx_typedef() {return vx_test::t_file_test->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_file_test::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "file-test", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_test::vx_empty(std::shared_ptr<T> val) {return vx_test::e_file_test;}
    template <class T> std::shared_ptr<T> vx_test::Class_file_test::vx_type(std::shared_ptr<T> val) {return vx_test::t_file_test;}

    vx_core::Type_any vx_test::Class_file_test::vx_repl(vx_core::Type_anylist arglist) {
      vx_core::Type_any output = vx_core::e_any;
  ...
  vx_test::Func_file_test vx_test::e_file_test = std::make_shared<vx_test::Class_file_test>();
  vx_test::Func_file_test vx_test::t_file_test = std::make_shared<vx_test::Class_file_test>();
  ...
  //class Func_file_testhtml {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_testhtml::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_testhtml output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_file_testhtml::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_testhtml output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_file_testhtml::vx_typedef() {return vx_test::t_file_testhtml->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_file_testhtml::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "file-testhtml", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_testhtml::vx_empty(std::shared_ptr<T> val) {return vx_test::e_file_testhtml;}
    template <class T> std::shared_ptr<T> vx_test::Class_file_testhtml::vx_type(std::shared_ptr<T> val) {return vx_test::t_file_testhtml;}

    vx_core::Type_any vx_test::Class_file_testhtml::vx_repl(vx_core::Type_anylist arglist) {
      vx_core::Type_any output = vx_core::e_any;
  ...
  vx_test::Func_file_testhtml vx_test::e_file_testhtml = std::make_shared<vx_test::Class_file_testhtml>();
  vx_test::Func_file_testhtml vx_test::t_file_testhtml = std::make_shared<vx_test::Class_file_testhtml>();
  ...
  //class Func_file_testnode {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_testnode::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_testnode output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_file_testnode::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_file_testnode output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_file_testnode::vx_typedef() {return vx_test::t_file_testnode->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_file_testnode::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "file-testnode", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_file_testnode::vx_empty(std::shared_ptr<T> val) {return vx_test::e_file_testnode;}
    template <class T> std::shared_ptr<T> vx_test::Class_file_testnode::vx_type(std::shared_ptr<T> val) {return vx_test::t_file_testnode;}

    vx_core::Type_any vx_test::Class_file_testnode::vx_repl(vx_core::Type_anylist arglist) {
      vx_core::Type_any output = vx_core::e_any;
  ...
  vx_test::Func_file_testnode vx_test::e_file_testnode = std::make_shared<vx_test::Class_file_testnode>();
  vx_test::Func_file_testnode vx_test::t_file_testnode = std::make_shared<vx_test::Class_file_testnode>();
  ...
  //class Func_html_from_divtest {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_html_from_divtest::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_html_from_divtest output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_html_from_divtest::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_html_from_divtest output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_html_from_divtest::vx_typedef() {return vx_test::t_html_from_divtest->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_html_from_divtest::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "html<-divtest", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_html_from_divtest::vx_empty(std::shared_ptr<T> val) {return vx_test::e_html_from_divtest;}
    template <class T> std::shared_ptr<T> vx_test::Class_html_from_divtest::vx_type(std::shared_ptr<T> val) {return vx_test::t_html_from_divtest;}

    vx_core::Func_any_from_any vx_test::Class_html_from_divtest::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_html_from_divtest::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_html_from_divtest vx_test::e_html_from_divtest = std::make_shared<vx_test::Class_html_from_divtest>();
  vx_test::Func_html_from_divtest vx_test::t_html_from_divtest = std::make_shared<vx_test::Class_html_from_divtest>();
  ...
  //class Func_p_from_passfail {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_passfail::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_p_from_passfail output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_p_from_passfail::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_p_from_passfail output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_p_from_passfail::vx_typedef() {return vx_test::t_p_from_passfail->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_p_from_passfail::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "p<-passfail", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_passfail::vx_empty(std::shared_ptr<T> val) {return vx_test::e_p_from_passfail;}
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_passfail::vx_type(std::shared_ptr<T> val) {return vx_test::t_p_from_passfail;}

    vx_core::Func_any_from_any vx_test::Class_p_from_passfail::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_p_from_passfail::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_p_from_passfail vx_test::e_p_from_passfail = std::make_shared<vx_test::Class_p_from_passfail>();
  vx_test::Func_p_from_passfail vx_test::t_p_from_passfail = std::make_shared<vx_test::Class_p_from_passfail>();
  ...
  //class Func_p_from_testcoveragenums {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_testcoveragenums::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_p_from_testcoveragenums output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_p_from_testcoveragenums::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_p_from_testcoveragenums output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_p_from_testcoveragenums::vx_typedef() {return vx_test::t_p_from_testcoveragenums->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_p_from_testcoveragenums::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_testcoveragenums::vx_empty(std::shared_ptr<T> val) {return vx_test::e_p_from_testcoveragenums;}
    template <class T> std::shared_ptr<T> vx_test::Class_p_from_testcoveragenums::vx_type(std::shared_ptr<T> val) {return vx_test::t_p_from_testcoveragenums;}

    vx_core::Func_any_from_any vx_test::Class_p_from_testcoveragenums::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_p_from_testcoveragenums::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_p_from_testcoveragenums vx_test::e_p_from_testcoveragenums = std::make_shared<vx_test::Class_p_from_testcoveragenums>();
  vx_test::Func_p_from_testcoveragenums vx_test::t_p_from_testcoveragenums = std::make_shared<vx_test::Class_p_from_testcoveragenums>();
  ...
  //class Func_resolve_testcase {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcase::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testcase output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcase::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testcase output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testcase::vx_typedef() {return vx_test::t_resolve_testcase->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testcase::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcase::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testcase;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcase::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testcase;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testcase::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testcase::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testcase inputval = vx_core::f_any_from_any(vx_test::t_testcase, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testcase>> future = vx_test::f_resolve_testcase(inputval);
  ...
  vx_test::Func_resolve_testcase vx_test::e_resolve_testcase = std::make_shared<vx_test::Class_resolve_testcase>();
  vx_test::Func_resolve_testcase vx_test::t_resolve_testcase = std::make_shared<vx_test::Class_resolve_testcase>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testcase>> vx_test::f_resolve_testcase(vx_test::Type_testcase testcase) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testcase>> output = vx_core::async_new_from_val(vx_test::e_testcase);
    vx_core::f_let_async(
      vx_test::t_testcase,
  ...
  //class Func_resolve_testcaselist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcaselist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testcaselist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcaselist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testcaselist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testcaselist::vx_typedef() {return vx_test::t_resolve_testcaselist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testcaselist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcaselist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testcaselist;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testcaselist::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testcaselist;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testcaselist::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testcaselist::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testcaselist inputval = vx_core::f_any_from_any(vx_test::t_testcaselist, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testcaselist>> future = vx_test::f_resolve_testcaselist(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testcaselist vx_test::e_resolve_testcaselist = std::make_shared<vx_test::Class_resolve_testcaselist>();
  vx_test::Func_resolve_testcaselist vx_test::t_resolve_testcaselist = std::make_shared<vx_test::Class_resolve_testcaselist>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testcaselist>> vx_test::f_resolve_testcaselist(vx_test::Type_testcaselist testcaselist) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testcaselist>> output = vx_core::async_new_from_val(vx_test::e_testcaselist);
  ...
  //class Func_resolve_testdescribe {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribe::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testdescribe output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribe::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testdescribe output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testdescribe::vx_typedef() {return vx_test::t_resolve_testdescribe->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testdescribe::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribe::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testdescribe;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribe::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testdescribe;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testdescribe::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testdescribe::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testdescribe inputval = vx_core::f_any_from_any(vx_test::t_testdescribe, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testdescribe>> future = vx_test::f_resolve_testdescribe(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testdescribe vx_test::e_resolve_testdescribe = std::make_shared<vx_test::Class_resolve_testdescribe>();
  vx_test::Func_resolve_testdescribe vx_test::t_resolve_testdescribe = std::make_shared<vx_test::Class_resolve_testdescribe>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testdescribe>> vx_test::f_resolve_testdescribe(vx_test::Type_testdescribe testdescribe) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testdescribe>> output = vx_core::async_new_from_val(vx_test::e_testdescribe);
    vx_core::f_let_async(
  ...
  //class Func_resolve_testdescribelist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribelist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testdescribelist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribelist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testdescribelist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testdescribelist::vx_typedef() {return vx_test::t_resolve_testdescribelist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testdescribelist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testdescribelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testdescribelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testdescribelist;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testdescribelist::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testdescribelist::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testdescribelist inputval = vx_core::f_any_from_any(vx_test::t_testdescribelist, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testdescribelist>> future = vx_test::f_resolve_testdescribelist(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testdescribelist vx_test::e_resolve_testdescribelist = std::make_shared<vx_test::Class_resolve_testdescribelist>();
  vx_test::Func_resolve_testdescribelist vx_test::t_resolve_testdescribelist = std::make_shared<vx_test::Class_resolve_testdescribelist>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testdescribelist>> vx_test::f_resolve_testdescribelist(vx_test::Type_testdescribelist testdescribelist) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testdescribelist>> output = vx_core::async_new_from_val(vx_test::e_testdescribelist);
    output = vx_core::f_list_from_list_async(
  ...
  //class Func_resolve_testpackage {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackage::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testpackage output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackage::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testpackage output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testpackage::vx_typedef() {return vx_test::t_resolve_testpackage->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testpackage::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackage::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testpackage;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackage::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testpackage;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testpackage::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testpackage::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testpackage inputval = vx_core::f_any_from_any(vx_test::t_testpackage, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testpackage>> future = vx_test::f_resolve_testpackage(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testpackage vx_test::e_resolve_testpackage = std::make_shared<vx_test::Class_resolve_testpackage>();
  vx_test::Func_resolve_testpackage vx_test::t_resolve_testpackage = std::make_shared<vx_test::Class_resolve_testpackage>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testpackage>> vx_test::f_resolve_testpackage(vx_test::Type_testpackage testpackage) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testpackage>> output = vx_core::async_new_from_val(vx_test::e_testpackage);
    vx_core::f_let_async(
  ...
  //class Func_resolve_testpackagelist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackagelist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testpackagelist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackagelist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testpackagelist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testpackagelist::vx_typedef() {return vx_test::t_resolve_testpackagelist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testpackagelist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackagelist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testpackagelist;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testpackagelist::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testpackagelist;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testpackagelist::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testpackagelist::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testpackagelist inputval = vx_core::f_any_from_any(vx_test::t_testpackagelist, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testpackagelist>> future = vx_test::f_resolve_testpackagelist(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testpackagelist vx_test::e_resolve_testpackagelist = std::make_shared<vx_test::Class_resolve_testpackagelist>();
  vx_test::Func_resolve_testpackagelist vx_test::t_resolve_testpackagelist = std::make_shared<vx_test::Class_resolve_testpackagelist>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testpackagelist>> vx_test::f_resolve_testpackagelist(vx_test::Type_testpackagelist testpackagelist) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testpackagelist>> output = vx_core::async_new_from_val(vx_test::e_testpackagelist);
    output = vx_core::f_list_from_list_async(
  ...
  //class Func_resolve_testresult {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testresult::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testresult output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testresult::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_resolve_testresult output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_resolve_testresult::vx_typedef() {return vx_test::t_resolve_testresult->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_resolve_testresult::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testresult::vx_empty(std::shared_ptr<T> val) {return vx_test::e_resolve_testresult;}
    template <class T> std::shared_ptr<T> vx_test::Class_resolve_testresult::vx_type(std::shared_ptr<T> val) {return vx_test::t_resolve_testresult;}

    vx_core::Func_any_from_any_async vx_test::Class_resolve_testresult::fn_new(vx_core::Class_any_from_any_async::IFn fn) {return vx_core::e_any_from_any_async;}

    template <class T, class U> std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> vx_test::Class_resolve_testresult::f_any_from_any_async(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      vx_test::Type_testresult inputval = vx_core::f_any_from_any(vx_test::t_testresult, value);
      std::shared_ptr<vx_core::Async<vx_test::Type_testresult>> future = vx_test::f_resolve_testresult(inputval);
      std::shared_ptr<vx_core::Async<std::shared_ptr<T>>> output = (vx_core::Async<std::shared_ptr<T>>)future;
      return output;
    }
  ...
  vx_test::Func_resolve_testresult vx_test::e_resolve_testresult = std::make_shared<vx_test::Class_resolve_testresult>();
  vx_test::Func_resolve_testresult vx_test::t_resolve_testresult = std::make_shared<vx_test::Class_resolve_testresult>();

  std::shared_ptr<vx_core::Async<vx_test::Type_testresult>> vx_test::f_resolve_testresult(vx_test::Type_testresult testresult) {
    std::shared_ptr<vx_core::Async<vx_test::Type_testresult>> output = vx_core::async_new_from_val(vx_test::e_testresult);
    vx_core::f_let_async(
  ...
  //class Func_test {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test::vx_typedef() {return vx_test::t_test->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test;}
    template <class T> std::shared_ptr<T> vx_test::Class_test::vx_type(std::shared_ptr<T> val) {return vx_test::t_test;}
  ...
  vx_test::Func_test vx_test::e_test = std::make_shared<vx_test::Class_test>();
  ...
  //class Func_test_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_1::vx_typedef() {return vx_test::t_test_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_1;}
  ...
  vx_test::Func_test_1 vx_test::e_test_1 = std::make_shared<vx_test::Class_test_1>();
  ...
  //class Func_test_false {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_false::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_false output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_false::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_false output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_false::vx_typedef() {return vx_test::t_test_false->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_false::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-false", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_false::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_false;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_false::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_false;}

    vx_core::Func_any_from_any_context vx_test::Class_test_false::fn_new(vx_core::Class_any_from_any_context::IFn fn) {return vx_core::e_any_from_any_context;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_test_false::f_any_from_any_context(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value, vx_core::Type_context context) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_test_false vx_test::e_test_false = std::make_shared<vx_test::Class_test_false>();
  ...
  //class Func_test_false_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_false_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_false_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_false_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_false_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_false_1::vx_typedef() {return vx_test::t_test_false_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_false_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-false", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_false_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_false_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_false_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_false_1;}

    vx_core::Func_any_from_any_context vx_test::Class_test_false_1::fn_new(vx_core::Class_any_from_any_context::IFn fn) {return vx_core::e_any_from_any_context;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_test_false_1::f_any_from_any_context(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value, vx_core::Type_context context) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_test_false_1 vx_test::e_test_false_1 = std::make_shared<vx_test::Class_test_false_1>();
  ...
  //class Func_test_gt {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_gt output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_gt::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_gt output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_gt::vx_typedef() {return vx_test::t_test_gt->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_gt::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-gt", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_gt;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_gt;}
  ...
  vx_test::Func_test_gt vx_test::e_test_gt = std::make_shared<vx_test::Class_test_gt>();
  ...
  //class Func_test_gt_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_gt_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_gt_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_gt_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_gt_1::vx_typedef() {return vx_test::t_test_gt_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_gt_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-gt", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_gt_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_gt_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_gt_1;}
  ...
  vx_test::Func_test_gt_1 vx_test::e_test_gt_1 = std::make_shared<vx_test::Class_test_gt_1>();
  ...
  //class Func_test_ne {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_ne output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_ne::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_ne output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_ne::vx_typedef() {return vx_test::t_test_ne->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_ne::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-ne", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_ne;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_ne;}
  ...
  vx_test::Func_test_ne vx_test::e_test_ne = std::make_shared<vx_test::Class_test_ne>();
  ...
  //class Func_test_ne_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_ne_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_ne_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_ne_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_ne_1::vx_typedef() {return vx_test::t_test_ne_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_ne_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-ne", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_ne_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_ne_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_ne_1;}
  ...
  vx_test::Func_test_ne_1 vx_test::e_test_ne_1 = std::make_shared<vx_test::Class_test_ne_1>();
  ...
  //class Func_test_string {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_string::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_string output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_string::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_string output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_string::vx_typedef() {return vx_test::t_test_string->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_string::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-string", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_string::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_string;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_string::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_string;}
  ...
  vx_test::Func_test_string vx_test::e_test_string = std::make_shared<vx_test::Class_test_string>();
  ...
  //class Func_test_string_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_string_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_string_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_string_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_string_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_string_1::vx_typedef() {return vx_test::t_test_string_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_string_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-string", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_string_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_string_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_string_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_string_1;}
  ...
  vx_test::Func_test_string_1 vx_test::e_test_string_1 = std::make_shared<vx_test::Class_test_string_1>();
  ...
  //class Func_test_true {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_true::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_true output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_true::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_true output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_true::vx_typedef() {return vx_test::t_test_true->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_true::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-true", // name
        0, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_true::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_true;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_true::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_true;}

    vx_core::Func_any_from_any_context vx_test::Class_test_true::fn_new(vx_core::Class_any_from_any_context::IFn fn) {return vx_core::e_any_from_any_context;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_test_true::f_any_from_any_context(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value, vx_core::Type_context context) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
      vx_core::Type_any inputval = (vx_core::Type_any)value;
  ...
  vx_test::Func_test_true vx_test::e_test_true = std::make_shared<vx_test::Class_test_true>();
  ...
  //class Func_test_true_1 {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_true_1::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_true_1 output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_test_true_1::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_test_true_1 output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_test_true_1::vx_typedef() {return vx_test::t_test_true_1->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_test_true_1::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
        "test-true", // name
        1, // idx
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_test_true_1::vx_empty(std::shared_ptr<T> val) {return vx_test::e_test_true_1;}
    template <class T> std::shared_ptr<T> vx_test::Class_test_true_1::vx_type(std::shared_ptr<T> val) {return vx_test::t_test_true_1;}

    vx_core::Func_any_from_any_context vx_test::Class_test_true_1::fn_new(vx_core::Class_any_from_any_context::IFn fn) {return vx_core::e_any_from_any_context;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_test_true_1::f_any_from_any_context(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value, vx_core::Type_context context) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
      vx_core::Func_any_from_func_async inputval = (vx_core::Func_any_from_func_async)value;
  ...
  vx_test::Func_test_true_1 vx_test::e_test_true_1 = std::make_shared<vx_test::Class_test_true_1>();
  ...
  //class Func_tr_from_testdescribe_casename {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_tr_from_testdescribe_casename::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_tr_from_testdescribe_casename output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_tr_from_testdescribe_casename::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_tr_from_testdescribe_casename output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_tr_from_testdescribe_casename::vx_typedef() {return vx_test::t_tr_from_testdescribe_casename->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_tr_from_testdescribe_casename::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_tr_from_testdescribe_casename::vx_empty(std::shared_ptr<T> val) {return vx_test::e_tr_from_testdescribe_casename;}
    template <class T> std::shared_ptr<T> vx_test::Class_tr_from_testdescribe_casename::vx_type(std::shared_ptr<T> val) {return vx_test::t_tr_from_testdescribe_casename;}
  ...
  vx_test::Func_tr_from_testdescribe_casename vx_test::e_tr_from_testdescribe_casename = std::make_shared<vx_test::Class_tr_from_testdescribe_casename>();
  vx_test::Func_tr_from_testdescribe_casename vx_test::t_tr_from_testdescribe_casename = std::make_shared<vx_test::Class_tr_from_testdescribe_casename>();
  ...
  //class Func_trlist_from_testcase {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcase::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_trlist_from_testcase output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcase::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_trlist_from_testcase output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_trlist_from_testcase::vx_typedef() {return vx_test::t_trlist_from_testcase->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_trlist_from_testcase::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcase::vx_empty(std::shared_ptr<T> val) {return vx_test::e_trlist_from_testcase;}
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcase::vx_type(std::shared_ptr<T> val) {return vx_test::t_trlist_from_testcase;}

    vx_core::Func_any_from_any vx_test::Class_trlist_from_testcase::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_trlist_from_testcase::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
  ...
  vx_test::Func_trlist_from_testcase vx_test::e_trlist_from_testcase = std::make_shared<vx_test::Class_trlist_from_testcase>();
  vx_test::Func_trlist_from_testcase vx_test::t_trlist_from_testcase = std::make_shared<vx_test::Class_trlist_from_testcase>();
  ...
  //class Func_trlist_from_testcaselist {
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcaselist::vx_new(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_trlist_from_testcaselist output;
      return output;
    }

    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcaselist::vx_copy(std::shared_ptr<T> generic_any_1, vx_core::vx_Type_listarg vals) {
      vx_test::Func_trlist_from_testcaselist output;
      return output;
    }

    vx_core::Type_typedef vx_test::Class_trlist_from_testcaselist::vx_typedef() {return vx_test::t_trlist_from_testcaselist->vx_typedef();}

    vx_core::Type_funcdef vx_test::Class_trlist_from_testcaselist::vx_funcdef() {
      return vx_core::Class_funcdef::vx_funcdef_new(
        "vx/test", // pkgname
    ...
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcaselist::vx_empty(std::shared_ptr<T> val) {return vx_test::e_trlist_from_testcaselist;}
    template <class T> std::shared_ptr<T> vx_test::Class_trlist_from_testcaselist::vx_type(std::shared_ptr<T> val) {return vx_test::t_trlist_from_testcaselist;}

    vx_core::Func_any_from_any vx_test::Class_trlist_from_testcaselist::fn_new(vx_core::Class_any_from_any::IFn fn) {return vx_core::e_any_from_any;}

    template <class T, class U> std::shared_ptr<T> vx_test::Class_trlist_from_testcaselist::f_any_from_any(std::shared_ptr<T> generic_any_1, std::shared_ptr<U> value) {
      std::shared_ptr<T> output = vx_core::f_empty(generic_any_1);
      vx_test::Type_testcaselist inputval = (vx_test::Type_testcaselist)value;
  ...
  vx_test::Func_trlist_from_testcaselist vx_test::e_trlist_from_testcaselist = std::make_shared<vx_test::Class_trlist_from_testcaselist>();
  vx_test::Func_trlist_from_testcaselist vx_test::t_trlist_from_testcaselist = std::make_shared<vx_test::Class_trlist_from_testcaselist>();
