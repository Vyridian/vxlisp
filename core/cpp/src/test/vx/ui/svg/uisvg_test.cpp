#include "../../../../main/vx/ui/svg/uisvg.hpp"
#include "../../../../main/vx/core.hpp"
#include "../../../../main/vx/test.hpp"
#include "../../../../main/vx/ui/ui.hpp"
#include "uisvg_test.hpp"

namespace vx_ui_svg_uisvg_test {
  ...
  vx_test::Type_testcoveragesummary test_coveragesummary() {
    vx_test::Type_testcoveragesummary output = vx_core::vx_new(vx_test::t_testcoveragesummary, {
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/ui/svg/uisvg"),
  ...
  vx_test::Type_testpackage test_package(vx_core::Type_context context) {
    vx_test::Type_testcaselist testcaselist = vx_ui_svg_uisvg_test::test_cases(context);
    vx_test::Type_testcoveragesummary testcoveragesummary = vx_ui_svg_uisvg_test::test_coveragesummary();
    vx_test::Type_testcoveragedetail testcoveragedetail = vx_ui_svg_uisvg_test::test_coveragedetail();
