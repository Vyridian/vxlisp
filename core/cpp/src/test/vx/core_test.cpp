...
namespace vx_core_test {
  ...
  vx_test::Type_testcase f_ne(vx_core::Type_context context) {
    ...
    // testdescribe_2
    vx_test::Type_testresult testresult_2 = vx_test::f_test_ne(vx_core::vx_new_string("a"), vx_core::vx_new_string("b"), context);
    vx_test::Type_testdescribe testdescribe_2 = vx_core::vx_new(vx_test::t_testdescribe, {
  ...
  vx_test::Type_testcase f_first_from_list_fn_any_from_any(vx_core::Type_context context) {
    vx_core::vx_log("Test Start: f_first_from_list_fn_any_from_any");
    // testdescribe_1
    vx_test::Type_testresult testresult_1 = vx_test::f_test(
      vx_core::vx_new_string("b"),
    ...
    vx_core::vx_log("Test End  : f_first_from_list_fn_any_from_any");
    return output;
  }
  ...
  vx_test::Type_testcoveragesummary test_coveragesummary() {
    vx_test::Type_testcoveragesummary output = vx_core::vx_new(vx_test::t_testcoveragesummary, {
      ...
      vx_core::vx_new_string(":docnums"), vx_core::vx_new(vx_test::t_testcoveragenums, {
        vx_core::vx_new_string(":pct"), vx_core::vx_new_int(84), 
        vx_core::vx_new_string(":tests"), vx_core::vx_new_int(198), 
        vx_core::vx_new_string(":total"), vx_core::vx_new_int(233)
      }),
      vx_core::vx_new_string(":funcnums"), vx_core::vx_new(vx_test::t_testcoveragenums, {
        vx_core::vx_new_string(":pct"), vx_core::vx_new_int(44), 
        vx_core::vx_new_string(":tests"), vx_core::vx_new_int(58), 
        vx_core::vx_new_string(":total"), vx_core::vx_new_int(129)
      }),
      vx_core::vx_new_string(":bigospacenums"), vx_core::vx_new(vx_test::t_testcoveragenums, {
        vx_core::vx_new_string(":pct"), vx_core::vx_new_int(0), 
        vx_core::vx_new_string(":tests"), vx_core::vx_new_int(0), 
        vx_core::vx_new_string(":total"), vx_core::vx_new_int(153)
      }),
      ...
      vx_core::vx_new_string(":totalnums"), vx_core::vx_new(vx_test::t_testcoveragenums, {
        ...
        vx_core::vx_new_string(":total"), vx_core::vx_new_int(209)
      }),
