...
namespace vx_translation_en_test {
  ...
  vx_test::Type_testcase f_translation_en(vx_core::Type_context context) {
    ...
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      ...
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/translation/en"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      ...
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/translation/en"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("translation-en"),
    ...
    vx_core::vx_log("Test End  : f_translation_en");
    return output;
  }

  vx_test::Type_testcaselist test_cases(vx_core::Type_context context) {
    vx_core::vx_Type_listany listtestcase;
    listtestcase.push_back(vx_translation_en_test::f_translation_en(context));
  ...
  vx_test::Type_testpackage test_package(vx_core::Type_context context) {
    vx_test::Type_testcaselist testcaselist = vx_translation_en_test::test_cases(context);
    vx_test::Type_testcoveragesummary testcoveragesummary = vx_translation_en_test::test_coveragesummary();
    vx_test::Type_testcoveragedetail testcoveragedetail = vx_translation_en_test::test_coveragedetail();
