...
namespace vx_translation_es_test {
  ...
  vx_test::Type_testcase f_translation_es(vx_core::Type_context context) {
    ...
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      ...
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/translation/es"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      ...
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/translation/es"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("translation-es"),
    ...
    vx_core::vx_log("Test End  : f_translation_es");
    return output;
  }

  vx_test::Type_testcaselist test_cases(vx_core::Type_context context) {
    vx_core::vx_Type_listany listtestcase;
    listtestcase.push_back(vx_translation_es_test::f_translation_es(context));
  ...
  vx_test::Type_testcoveragedetail test_coveragedetail() {
    vx_test::Type_testcoveragedetail output = vx_core::vx_new(vx_test::t_testcoveragedetail, {
      ...
      vx_core::vx_new_string(":funcmap"), vx_core::vx_new(vx_core::t_intmap, {
        vx_core::vx_new_string(":translation-es"), vx_core::vx_new_int(1),
  ...
  vx_test::Type_testpackage test_package(vx_core::Type_context context) {
    vx_test::Type_testcaselist testcaselist = vx_translation_es_test::test_cases(context);
    vx_test::Type_testcoveragesummary testcoveragesummary = vx_translation_es_test::test_coveragesummary();
    vx_test::Type_testcoveragedetail testcoveragedetail = vx_translation_es_test::test_coveragedetail();
