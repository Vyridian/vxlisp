...
namespace vx_data_tree_test {
  ...
  vx_test::Type_testcoveragesummary test_coveragesummary() {
    vx_test::Type_testcoveragesummary output = vx_core::vx_new(vx_test::t_testcoveragesummary(), {
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/data/tree"),
  ...
  vx_test::Type_testcoveragedetail test_coveragedetail() {
    vx_test::Type_testcoveragedetail output = vx_core::vx_new(vx_test::t_testcoveragedetail(), {
      ...
      vx_core::vx_new_string(":typemap"), vx_core::vx_new(vx_core::t_intmap(), {
        vx_core::vx_new_string(":branch"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":brancharrow"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":branchlist"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":leaf"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":leaflist"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":tree"), vx_core::vx_new_int(0)
      }),
      vx_core::vx_new_string(":constmap"), vx_core::vx_new(vx_core::t_intmap(), {
        vx_core::vx_new_string(":brancharrow-down"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":brancharrow-up"), vx_core::vx_new_int(0),
        vx_core::vx_new_string(":brancharrow-updown"), vx_core::vx_new_int(0)
      }),
  ...
  vx_test::Type_testpackage test_package(vx_core::Type_context context) {
    vx_test::Type_testcaselist testcaselist = vx_data_tree_test::test_cases(context);
    vx_test::Type_testcoveragesummary testcoveragesummary = vx_data_tree_test::test_coveragesummary();
    vx_test::Type_testcoveragedetail testcoveragedetail = vx_data_tree_test::test_coveragedetail();
