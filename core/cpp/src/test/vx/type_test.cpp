...
namespace vx_type_test {
  ...
  vx_test::Type_testcase f_string_lowercase(vx_core::Type_context context) {
    ...
    vx_test::Type_testresult testresult_1 = vx_test::f_test(
      ...
      vx_type::f_string_lowercase(vx_core::vx_new_string("AbC"))
    );
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      vx_core::vx_new_string(":describename"), vx_core::vx_new_string("(test\n \"abc\"\n (string-lowercase\n  \"AbC\"))"),
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      vx_core::vx_new_string(":passfail"), vx_core::c_false,
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("string-lowercase"),
      vx_core::vx_new_string(":describelist"),
      vx_core::vx_any_from_any(
        vx_test::t_testdescribelist,
        vx_test::t_testdescribelist->vx_new_from_list(listdescribe)
    ...
    vx_core::vx_log("Test End  : f_string_lowercase");
    return output;
  }

  vx_test::Type_testcase f_string_outdent(vx_core::Type_context context) {
    vx_core::vx_log("Test Start: f_string_outdent");
    // testdescribe_1
    vx_test::Type_testresult testresult_1 = vx_test::f_test(
      context,
      vx_core::vx_new_string("ab"),
      vx_type::f_string_outdent(vx_core::vx_new_string("ab"))
    );
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      vx_core::vx_new_string(":describename"), vx_core::vx_new_string("(test\n \"ab\"\n (string-outdent\n  \"ab\"))"),
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
    ...
    vx_test::Type_testresult testresult_2 = vx_test::f_test(
      context,
      vx_core::vx_new_string("a\nb"),
      vx_type::f_string_outdent(vx_core::vx_new_string("\n a\n b"))
    );
    vx_test::Type_testdescribe testdescribe_2 = vx_core::vx_new(vx_test::t_testdescribe, {
      vx_core::vx_new_string(":describename"), vx_core::vx_new_string("(test\n \"a\nb\"\n (string-outdent\n  \"\n a\n b\"))"),
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      vx_core::vx_new_string(":passfail"), vx_core::c_false,
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("string-outdent"),
      vx_core::vx_new_string(":describelist"),
      vx_core::vx_any_from_any(
        vx_test::t_testdescribelist,
        vx_test::t_testdescribelist->vx_new_from_list(listdescribe)
    ...
    vx_core::vx_log("Test End  : f_string_outdent");
    return output;
  }

  vx_test::Type_testcase f_string_trim(vx_core::Type_context context) {
    vx_core::vx_log("Test Start: f_string_trim");
    // testdescribe_1
    vx_test::Type_testresult testresult_1 = vx_test::f_test(
      context,
      vx_core::vx_new_string("ab"),
      vx_type::f_string_trim(vx_core::vx_new_string(" \t\nab\n\t "))
    );
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      vx_core::vx_new_string(":describename"), vx_core::vx_new_string("(test\n \"ab\"\n (string-trim\n  \" \t\nab\n\t \"))"),
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      vx_core::vx_new_string(":passfail"), vx_core::c_false,
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("string-trim"),
      vx_core::vx_new_string(":describelist"),
      vx_core::vx_any_from_any(
        vx_test::t_testdescribelist,
        vx_test::t_testdescribelist->vx_new_from_list(listdescribe)
    ...
    vx_core::vx_log("Test End  : f_string_trim");
    return output;
  }

  vx_test::Type_testcase f_string_uppercase(vx_core::Type_context context) {
    vx_core::vx_log("Test Start: f_string_uppercase");
    // testdescribe_1
    vx_test::Type_testresult testresult_1 = vx_test::f_test(
      context,
      vx_core::vx_new_string("ABC"),
      vx_type::f_string_uppercase(vx_core::vx_new_string("aBc"))
    );
    vx_test::Type_testdescribe testdescribe_1 = vx_core::vx_new(vx_test::t_testdescribe, {
      vx_core::vx_new_string(":describename"), vx_core::vx_new_string("(test\n \"ABC\"\n (string-uppercase\n  \"aBc\"))"),
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
    ...
    vx_test::Type_testcase output = vx_core::vx_new(vx_test::t_testcase, {
      vx_core::vx_new_string(":passfail"), vx_core::c_false,
      vx_core::vx_new_string(":testpkg"), vx_core::vx_new_string("vx/type"),
      vx_core::vx_new_string(":casename"), vx_core::vx_new_string("string-uppercase"),
      vx_core::vx_new_string(":describelist"),
      vx_core::vx_any_from_any(
        vx_test::t_testdescribelist,
        vx_test::t_testdescribelist->vx_new_from_list(listdescribe)
    ...
    vx_core::vx_log("Test End  : f_string_uppercase");
    return output;
  }
  ...
  vx_test::Type_testcaselist test_cases(vx_core::Type_context context) {
    ...
    listtestcase.push_back(vx_type_test::f_string_uppercase(context));
  ...
  vx_test::Type_testcoveragedetail test_coveragedetail() {
    vx_test::Type_testcoveragedetail output = vx_core::vx_new(vx_test::t_testcoveragedetail, {
      ...
      vx_core::vx_new_string(":funcmap"), vx_core::vx_new(vx_core::t_intmap, {
        ...
        vx_core::vx_new_string(":string-uppercase"), vx_core::vx_new_int(1),
