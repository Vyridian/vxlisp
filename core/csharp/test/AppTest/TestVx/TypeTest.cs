...
public class TypeTest {
  ...
  static Test.Type_testcase f_boolean_from_string_ends(Vx.Core.Type_context context) {
  ...
  static Test.Type_testcase f_boolean_from_string_starts(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_int_from_string_find(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_int_from_string_findkeyword(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_int_from_string_findlast(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_is_string(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_is_type(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_is_type_from_any_typelist(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_lowercase(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_outdent(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_trim(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_uppercase(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_from_int(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_from_string_end(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_from_string_start(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_from_string_start_end(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_string_from_stringlist_join(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  static Test.Type_testcase f_stringlist_from_string_split(Vx.Core.Type_context context) {
    Test.Type_testcase output = Vx.Core.vx_new(
      Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/type",
  ...
  public static Test.Type_testcoveragesummary test_coveragesummary() {
    return Vx.Core.vx_new(
      ...
      ":docnums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 81, ":tests", 22, ":total", 27), 
      ":funcnums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 66, ":tests", 18, ":total", 27), 
      ":bigospacenums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 27), 
      ":bigotimenums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 0, ":tests", 0, ":total", 27), 
      ":totalnums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 66, ":tests", 18, ":total", 27), 
      ":typenums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 100, ":tests", 0, ":total", 0)
    );
  }

  public static Test.Type_testcoveragedetail test_coveragedetail() {
    return Vx.Core.vx_new(Test.t_testcoveragedetail, ":testpkg", "vx/type", ":typemap", Vx.Core.e_intmap, ":constmap", Vx.Core.e_intmap, ":funcmap", Vx.Core.vx_new(
  Vx.Core.t_intmap,
