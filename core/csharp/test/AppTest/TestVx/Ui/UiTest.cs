...
public class UiTest {
  ...
  static Vx.Test.Type_testcase f_boolean_writestate_from_uiapp(Vx.Core.Type_context context) {
            ...
            Vx.Test.f_test(
              ...
              Vx.Core.f_let(
                ...
                Vx.Core.t_any_from_func.vx_fn_new(() => {
                  ...
                  Vx.Core.Type_any output_20 = appui;
                  return output_20;
                })
              )
            )
  ...
  static Vx.Test.Type_testcase f_string_parentuid_from_uid(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
  ...
  static Vx.Test.Type_testcase f_ui_readstate_uiapp(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
            ...
            Vx.Test.f_test(
              ...
              Vx.Core.f_let(
                ...
                Vx.Core.t_any_from_func.vx_fn_new(() => {
                  ...
                  Vx.Core.Type_any output_21 = Vx.Ui.Ui.f_ui_readstate_uiapp(context);
                  return output_21;
                })
              )
            )
  ...
  static Vx.Test.Type_testcase f_ui_readstate_from_uid(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
            ...
            Vx.Test.f_test(
              ...
              Vx.Core.f_let(
                ...
                Vx.Core.t_any_from_func.vx_fn_new(() => {
                  ...
                  Vx.Core.Type_boolean isremoved = Vx.Ui.Ui.f_boolean_removestate_uiapp(context);
                  Vx.Core.Type_any output_22 = readval;
                  return output_22;
                })
              )
            )
  ...
  static Vx.Test.Type_testcase f_ui_write_from_ui_visible(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
  ...
  static Vx.Test.Type_testcase f_ui_from_ui_find(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
  ...
  static Vx.Test.Type_testcase f_ui_from_ui_selected(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      ":passfail", false,
      ":testpkg", "vx/ui/ui",
