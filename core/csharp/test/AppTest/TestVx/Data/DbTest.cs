...
public class DbTest {
  ...
  public static Test.Type_testcoveragesummary test_coveragesummary() {
    return Vx.Core.vx_new(
      ...
      ":docnums", Vx.Core.vx_new(Test.t_testcoveragenums, ":pct", 100, ":tests", 12, ":total", 12), 
  ...
  public static Test.Type_testcoveragedetail test_coveragedetail() {
    return Vx.Core.vx_new(Test.t_testcoveragedetail, ":testpkg", "vx/data/db", ":typemap", Vx.Core.vx_new(
  Vx.Core.t_intmap,
        ":db", 0,
        ":dbcell", 0,
        ":dbcellmap", 0,
