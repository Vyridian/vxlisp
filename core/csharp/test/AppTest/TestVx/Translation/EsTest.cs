...
public class EsTest {
  ...
  static Vx.Test.Type_testcase f_translation_es(Vx.Core.Type_context context) {
  ...
  public static Vx.Test.Type_testcoveragedetail test_coveragedetail() {
    return Vx.Core.vx_new(Vx.Test.t_testcoveragedetail, ":testpkg", "vx/translation/es", ":typemap", Vx.Core.e_intmap, ":constmap", Vx.Core.e_intmap, ":funcmap", Vx.Core.vx_new(
  Vx.Core.t_intmap,
        ":translation-es", 1,
        ":words", 0
      ));
