...
*/
  ...
  public static Vx.Core.Type_msgblock vx_msgblock_from_copy_arrayval(Vx.Core.Type_any copy, Object[] vals) {
  ...
  public static Vx.Core.Type_anylist vx_anylist_from_arraystring(string[] arraystring) {
  ...
  public static Vx.Core.Type_boolean f_is_pass_from_permission(Vx.Core.Type_context context, Vx.Core.Type_permission permission) {
    ...
    output = Vx.Core.f_let(
      ...
      Vx.Core.t_any_from_func.vx_fn_new(() => {
        ...
        return Vx.Core.f_eq(lookup, permission);
      })
    );
    return output;
  }
  ...
  public static T f_last_from_list<T, X>(T generic_any_1, X values) where T : Vx.Core.Type_any where X : Vx.Core.Type_list {
    ...
    output = Vx.Core.f_let(
      ...
      Vx.Core.t_any_from_func.vx_fn_new(() => {
        ...
        return Vx.Core.f_any_from_list(generic_any_1, values, len);
      })
    );
    return output;
  }
  ...
  public static Vx.Core.Type_permission f_permission_from_id_context(Vx.Core.Type_context context, Vx.Core.Type_string id) {
    ...
    output = Vx.Core.f_let(
      ...
      Vx.Core.t_any_from_func.vx_fn_new(() => {
        ...
        return Vx.Core.f_any_from_map(Vx.Core.t_permission, permissionmap, Vx.Core.vx_new_string(":id"));
      })
    );
    return output;
  }
