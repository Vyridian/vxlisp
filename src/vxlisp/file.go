...
func ListStringReadFromPathExtension(
	path string,
	extension string) ([]string, *vxmsgblock) {
	var files []string
...
func PathAbsoluteFromPath(
	path string) (string, error) {
	output, err := filepath.Abs(path)
	return output, err
}

func PathFromPathRelativePath(
	basepath string,
...
func StringFromListFile(
	listfile []*vxfile) string {
	var output string
...
func StringFromReadTextFile(
	filename string) (string, *vxmsgblock) {
	text := ""
...
func TextblockFromReadFile(
	filename string) (*vxtextblock, *vxmsgblock) {
...
func WriteFileFromFilenameText(
	filename string,
